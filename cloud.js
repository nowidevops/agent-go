...
// "for now" (user directive). All five are Ollama-Cloud flat-rate ($0.15/turn), so
// billing exposure is uniform. To UN-HIDE the vendor models later, restore the
...
export const CLOUD_MODELS = {
  ollamaCloud: [
    ...
    { id: "glm-5.2:cloud",             label: "glm-5.2:cloud — GLM 5.2 (strongest · orchestrator · default)" },
    ...
    { id: "kimi-k3:cloud",             label: "kimi-k3:cloud — Kimi K3 (newest Kimi · general)" },
  ...
  // openai:    [ { id: "gpt-5-nano", label: "gpt-5-nano — cheapest" }, { id: "gpt-5-mini", label: "gpt-5-mini" }, { id: "gpt-5.6-luna", label: "gpt-5.6-luna" }, { id: "gpt-5.6-terra", label: "gpt-5.6-terra" }, { id: "gpt-5.6-sol", label: "gpt-5.6-sol — top" } ],
...
// Default model = glm-5.2:cloud (the agentic Ollama-Cloud brain; matches settings.js DEFAULTS.model).
